...
cdef class DITask(Task):
    ...
    cdef uInt32[] read(Task self, int32 numSamples, float64 timeout=10., bool32 fillMode=DAQmx_Val_GroupByChannel):
        ...
        if not self._started:
            # TODO: raise error
            pass
        wrap_error(DAQmxBaseReadDigitalU32(self.handle, self._nchans, timeout, fillMode, &sampsPerChanRead, NULL))
